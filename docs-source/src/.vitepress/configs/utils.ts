...
export const env = {
    // VitePress loads its site config before NODE_ENV is reliably set for the dev command.
...
export const markdown = {
    ...
    /** Rewrites locale fragments and project-owned link schemes for the active build mode. */
